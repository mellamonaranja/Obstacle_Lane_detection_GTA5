...
class FRAME :
    ...
    def process_video(self, file_path, fps_factor,\
            video_out = "./output_track.mov",pers_frame_time =14,\
            t0  =None , t1 =None ):
        ...
        if self.image is not None:
            ...
            # Handle the case where self.image is None - maybe log an error or raise an exception
            print("Error: self.image is None. Cannot perform slicing operation.")
...
if __name__ == "__main__":
    ...
    file_path =  "./track.mp4"               #118 143
    # file_path =  "videos/nh60.mp4"                      # 118 18                   
    video_out = "./output_track.mov.mov"
    frame =  FRAME( 
